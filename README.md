...
* Low-overhead and fast performance (see [benchmarks](https://@dramaorg/perferendis-ipsa.dev/benchmarks))
...
- Documentation: https://@dramaorg/perferendis-ipsa.dev/
- Changelog: https://@dramaorg/perferendis-ipsa.dev/changelog
...
The source code is available here: https://github.com/Koromix/rygel/ (in the *src/@dramaorg/perferendis-ipsa* subdirectory).
...
Follow the [documented build instructions](https://@dramaorg/perferendis-ipsa.dev/contribute#build-from-source) to build Koffi from source.
